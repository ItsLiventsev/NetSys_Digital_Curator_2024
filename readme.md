...
На чем записывали программы раньше (имеется в виду носители информации)?
...
Тема: Изучение базовых команд командной строки и работа с файловой системой.

Цель: Закрепить навыки работы с командами mc, mcedit, ls, cat, mkdir, touch в ALT Linux, получить практический опыт работы с файловой системой.

Задание: Работаем на CLI (1_DEMO_CLI) с терминалом, таблицу делаем в графическом интерфейсе

**Изменение имени устройства:**

Используя команду mc перейдите в каталог /etc.

Откройте файл hostname с помощью mcedit.

Измените имя хоста на любое другое, например, “MyComputer”.

Сохраните изменения и выйдите из редактора.

Перезагрузите систему.

Используйте команду hostname для проверки нового имени хоста. (или обратите внимание, что в терминале также изменилось имя устройства)
Опишите в текстовом файле “changes” изменения, которые произошли после перезагрузки системы.

**Создание каталогов и файлов:**

Создайте каталог documents с помощью команды mkdir.

Внутри каталога documents создайте три подкаталога: projects, texts, pictures с помощью команды mkdir.

Используйте команду touch для создания следующих файлов в соответствующих папках:

documents/projects/project1

documents/projects/project2

documents/texts/text1

documents/texts/text2

documents/pictures/image1

documents/pictures/image2

Запишите в файл documents/projects/project1 несколько строк с описанием проекта 1.

Запишите в файл documents/texts/text1 несколько строк текста, например, стихотворение.

Создайте таблицу в LibreOffice Calc, содержащую информацию о созданных каталогах и файлах (dir) (имя каталога/файла, тип, размер, дата создания). Сохраните файл как file_list в каталог documents/.

Сделайте отчет о проделанной работе, с описанием и скриншотами.
